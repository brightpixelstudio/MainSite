...
export function allBlogPostList() {
  return [
    {
      blogpostid: 1,
...
export function getBlogPost(blogPostURL: string): GetBlogPost {
  return allBlogPostList().find((post) => post.url === blogPostURL) as GetBlogPost;
}
